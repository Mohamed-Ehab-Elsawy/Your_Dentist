    ...
    AlertDialog(
        ...
        text = {
            Box(
                ...
                if (AppProviders.patientQRCodeBitmap != null) {
                    Image(
                        bitmap = AppProviders.patientQRCodeBitmap!!.asImageBitmap(),
                    ...
                    SubcomposeAsyncImage(
                        model = AppProviders.patient!!.qrCode,
                        ...
                        loading = {
                            ...
                            if (drawable is BitmapDrawable) {
                                ...
                                putQrCode.invoke(drawable.bitmap)
                            }
                        }
                    )
                }
