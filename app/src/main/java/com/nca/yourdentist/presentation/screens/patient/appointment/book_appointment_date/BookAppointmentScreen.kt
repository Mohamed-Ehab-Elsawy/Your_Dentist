...
import com.nca.yourdentist.presentation.screens.patient.appointment.book_appointment_date.components.DatePickerSection
import com.nca.yourdentist.presentation.screens.patient.appointment.book_appointment_date.components.ProfileSection
import com.nca.yourdentist.presentation.screens.patient.appointment.book_appointment_date.components.TimePickerSection
            ...
            item {
                ...
                CustomButton(
                    ...
                    onClick = {
                        ...
                        selectedAppointment?.dentistId = dentist.id
                        selectedAppointment?.dentistName = dentist.name
                        if (selectedAppointment != null && report != null)
                            vm.bookAppointment(
                                appointment = selectedAppointment,
                                report = report
                            )
                        else
                            Toast.makeText(context, "Report : null", Toast.LENGTH_SHORT).show()
                    }
                )
            }
        }
